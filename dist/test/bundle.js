(function () { function r(e, n, t) { function o(i, f) { if (!n[i]) {
    ...
    o(t[i]); return o; } return r; })()({ 1: [function (require, module, exports) {
            ...
            "use strict";
            var __awaiter = this && this.__awaiter || function (e, t, i, n) { return new (i || (i = Promise))((function (o, l) { function r(e) { try {
                d(n.next(e));
            }
            catch (e) {
                l(e);
                ...
                l(e);
            } } function d(e) { var t; e.done ? o(e.value) : (t = e.value, t instanceof i ? t : new i((function (e) { e(t); }))).then(r, a); } d((n = n.apply(e, t || [])).next()); })); };
            ...
            function wait(e) { for (var t = (new Date).getTime(), i = t; i < t + e;)
                i = (new Date).getTime(); }
            function getVideoDate(e) { var t, i, n; return __awaiter(this, void 0, void 0, (function* () { try {
                const o = (yield axios_1.default.get("https://m.youtube.com/watch?v=" + e, headers)).data, l = (null === (t = videoRegex.exec(o)) || void 0 === t ? void 0 : t[1]) || "{}", r = JSON.parse(l);
                let a = null === (n = null === (i = JSON.parse(r.args.player_response).microformat) || void 0 === i ? void 0 : i.playerMicroformatRenderer) || void 0 === n ? void 0 : n.publishDate;
                return a += " " + Math.floor(24 * Math.random()) + "-" + Math.floor(60 * Math.random()) + "-" + Math.floor(60 * Math.random()), moment(a, "YYYY-MM-DD H-m-s").toDate();
            }
            catch (t) {
            ...
            function getChannelDesc(e) { var t, i, n; return __awaiter(this, void 0, void 0, (function* () { try {
                const o = (yield axios_1.default.get("https://m.youtube.com/channel/" + encodeURI(e) + "/videos", headers)).data, l = (null === (t = mobileRegex.exec(o)) || void 0 === t ? void 0 : t[1]) || "{}", r = JSON.parse(l);
                return (null === (n = null === (i = r.metadata) || void 0 === i ? void 0 : i.channelMetadataRenderer) || void 0 === n ? void 0 : n.description) || "";
            }
            catch (t) {
                console.log("channel desc error for " + e, t);
            } })); }
            function searchVideo(e, t) { var i, n, o, l, r, a, d, s, u, c, v; return __awaiter(this, void 0, void 0, (function* () { try {
                let h = [], m = [];
                if (t) {
                    let e = (yield axios_1.default.get("https://youtube.com/browse_ajax?ctoken=" + t, headersAJAX)).data;
                    h = (null === (a = null === (r = e[1].response.continuationContents) || void 0 === r ? void 0 : r.gridContinuation) || void 0 === a ? void 0 : a.items) || "", t = (null === (v = null === (c = null === (u = null === (s = null === (d = e[1].response.continuationContents) || void 0 === d ? void 0 : d.gridContinuation) || void 0 === s ? void 0 : s.continuations) || void 0 === u ? void 0 : u[0]) || void 0 === c ? void 0 : c.nextContinuationData) || void 0 === v ? void 0 : v.continuation) || "";
                }
                else {
                    let r = (yield axios_1.default.get("https://m.youtube.com/results?sp=EgIQAQ%253D%253D&videoEmbeddable=true&search_query=" + e, headers)).data, a = (null === (i = mobileRegex.exec(r)) || void 0 === i ? void 0 : i[1]) || "{}", d = JSON.parse(a).contents.sectionListRenderer;
                    h = d.contents[0].itemSectionRenderer.contents, t = (null === (l = null === (o = null === (n = d.continuations) || void 0 === n ? void 0 : n[0]) || void 0 === o ? void 0 : o.reloadContinuationData) || void 0 === l ? void 0 : l.continuation) || "";
                }
            ...
            function searchChannel(e, t) { var i, n, o, l, r, a, d, s, u, c, v, h, m, g, f, p, x, b; return __awaiter(this, void 0, void 0, (function* () { try {
                let y = [], _ = [];
                if (t) {
                    let e = (yield axios_1.default.get("https://youtube.com/browse_ajax?ctoken=" + t, headersAJAX)).data;
                    ...
                    const s = (yield axios_1.default.get("https://m.youtube.com/results?sp=CAASAhAC&search_query=" + encodeURI(e), headers)).data, u = (null === (i = mobileRegex.exec(s)) || void 0 === i ? void 0 : i[1]) || "{}", c = JSON.parse(u);
                    y = null === (l = null === (o = null === (n = c.contents.sectionListRenderer) || void 0 === n ? void 0 : n.contents[0]) || void 0 === o ? void 0 : o.itemSectionRenderer) || void 0 === l ? void 0 : l.contents, t = (null === (d = null === (a = null === (r = c.continuations) || void 0 === r ? void 0 : r[0]) || void 0 === a ? void 0 : a.reloadContinuationData) || void 0 === d ? void 0 : d.continuation) || "";
                }
                for (let e = 0; e < y.length; e++)
                    if (y[e].compactChannelRenderer) {
                        const t = y[e].compactChannelRenderer;
                        let i = (null === (f = t.thumbnail) || void 0 === f ? void 0 : f.thumbnails[0].url) || "", n = (null === (p = t.thumbnail) || void 0 === p ? void 0 : p.thumbnails[1].url) || "";
                        i = i.startsWith("//") ? "https:" + i : i, n = n.startsWith("//") ? "https:" + n : n, _.push({ name: t.title.runs[0].text, channel_id: t.channelId, nb_videos: (null === (x = t.videoCountText) || void 0 === x ? void 0 : x.runs[0].text.replace(/[^0-9k]/g, "").replace("k", "000")) || 0, nb_subscriber: (null === (b = t.subscriberCountText) || void 0 === b ? void 0 : b.runs[0].text.replace(/[^0-9k]/g, "").replace("k", "000")) || 0, official: !!t.ownerBadges, channel_avatar_small: i, channel_avatar_medium: n });
                    }
            ...
            function getChannelVideos(e, t) { var i, n, o, l, r, a, d, s, u, c, v, h, m, g, f, p, x, b, y; return __awaiter(this, void 0, void 0, (function* () { try {
                const _ = (yield axios_1.default.get("https://m.youtube.com/channel/" + encodeURI(e) + "/videos", headers)).data, R = (null === (i = mobileRegex.exec(_)) || void 0 === i ? void 0 : i[1]) || "{}", C = JSON.parse(R), w = null === (d = null === (a = null === (r = null === (l = null === (o = null === (n = C.contents.singleColumnBrowseResultsRenderer) || void 0 === n ? void 0 : n.tabs[1]) || void 0 === o ? void 0 : o.tabRenderer) || void 0 === l ? void 0 : l.content) || void 0 === r ? void 0 : r.sectionListRenderer) || void 0 === a ? void 0 : a.contents[0]) || void 0 === d ? void 0 : d.itemSectionRenderer;
                let A = (null === (c = null === (u = null === (s = w.continuations) || void 0 === s ? void 0 : s[0]) || void 0 === u ? void 0 : u.nextContinuationData) || void 0 === c ? void 0 : c.continuation) || "", D = [];
                for (let e = 0; e < w.contents.length; e++) {
                    let i = yield formatVideo(w.contents[e]);
                    if (t) {
                        if (!moment(i.publishedAt).isAfter(t) || !t)
                            return D;
                        D.push(i);
                    }
                    else
                ...
                for (; "" !== A;)
                    try {
                        ...
                        let e = (yield axios_1.default.get("https://youtube.com/browse_ajax?ctoken=" + A, headersAJAX)).data, i = (null === (g = null === (m = null === (h = null === (v = e[1]) || void 0 === v ? void 0 : v.response) || void 0 === h ? void 0 : h.continuationContents) || void 0 === m ? void 0 : m.gridContinuation) || void 0 === g ? void 0 : g.items) || "";
            ...
            function formatVideo(e, t) { var i, n, o, l, r; return __awaiter(this, void 0, void 0, (function* () { try {
                if (e.compactVideoRenderer || e.gridVideoRenderer) {
                    let a = (e = e.compactVideoRenderer ? e.compactVideoRenderer : e.gridVideoRenderer).videoId, d = 0;
            ...
            module.exports = function xhrAdapter(config) {
                return new Promise(function dispatchXhrRequest(resolve, reject) {
                    ...
                    if ((utils.isBlob(requestData) || utils.isFile(requestData)) &&
                        requestData.type) {
                        delete requestHeaders['Content-Type']; // Let the browser set it
                    }

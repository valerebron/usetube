...
function getVideoDesc(e) { var t, o, i, n, l, d, a, r, u, s; return __awaiter(this, void 0, void 0, (function* () { try {
    ...
    return (null === (s = null === (u = null === (r = null === (a = null === (d = null === (l = null === (n = null === (i = null === (o = h.contents) || void 0 === o ? void 0 : o.singleColumnWatchNextResults) || void 0 === i ? void 0 : i.results) || void 0 === n ? void 0 : n.results) || void 0 === l ? void 0 : l.contents[1]) || void 0 === d ? void 0 : d.itemSectionRenderer) || void 0 === a ? void 0 : a.contents[0]) || void 0 === r ? void 0 : r.slimVideoMetadataRenderer) || void 0 === u ? void 0 : u.description) || void 0 === s ? void 0 : s.runs) || "";
}
catch (e) { } })); }
...
function searchVideo(e, t) { var o, i, n, l, d, a, r, u, s, c, v; return __awaiter(this, void 0, void 0, (function* () { try {
    let h = [], m = [], g = "";
    if (t) {
        let e = (yield axios_1.default.get("https://youtube.com/browse_ajax?ctoken=" + t, headersAJAX)).data;
        h = (null === (a = null === (d = e[1].response.continuationContents) || void 0 === d ? void 0 : d.gridContinuation) || void 0 === a ? void 0 : a.items) || "", t = (null === (v = null === (c = null === (s = null === (u = null === (r = e[1].response.continuationContents) || void 0 === r ? void 0 : r.gridContinuation) || void 0 === u ? void 0 : u.continuations) || void 0 === s ? void 0 : s[0]) || void 0 === c ? void 0 : c.nextContinuationData) || void 0 === v ? void 0 : v.continuation) || "";
    }
    else {
        let d = (yield axios_1.default.get("https://m.youtube.com/results?sp=EgIQAQ%253D%253D&videoEmbeddable=true&search_query=" + e, headers)).data, a = (null === (o = mobileRegex.exec(d)) || void 0 === o ? void 0 : o[1]) || "{}", r = JSON.parse(decodeHex(a)).contents.sectionListRenderer;
...
function searchChannel(e, t) { var o, i, n, l, d, a, r, u, s, c, v, h, m, g, x, p, f, y; return __awaiter(this, void 0, void 0, (function* () { try {
    let b = [], R = [], C = "";
    if (t) {
        let e = (yield axios_1.default.get("https://youtube.com/browse_ajax?ctoken=" + t, headersAJAX)).data;
        b = (null === (s = null === (u = e[1].response.continuationContents) || void 0 === u ? void 0 : u.gridContinuation) || void 0 === s ? void 0 : s.items) || "", t = (null === (g = null === (m = null === (h = null === (v = null === (c = e[1].response.continuationContents) || void 0 === c ? void 0 : c.gridContinuation) || void 0 === v ? void 0 : v.continuations) || void 0 === h ? void 0 : h[0]) || void 0 === m ? void 0 : m.nextContinuationData) || void 0 === g ? void 0 : g.continuation) || "";
    }
    else {
        const u = (yield axios_1.default.get("https://m.youtube.com/results?sp=CAASAhAC&search_query=" + encodeURI(e), headers)).data, s = (null === (o = mobileRegex.exec(u)) || void 0 === o ? void 0 : o[1]) || "{}", c = JSON.parse(decodeHex(s));
...
function getChannelVideos(e, t) { var o, i, n, l, d, a, r, u, s, c, v, h, m, g, x, p, f, y, b, R; return __awaiter(this, void 0, void 0, (function* () { try {
    const C = (yield axios_1.default.get("https://m.youtube.com/channel/" + e + "/videos", headers)).data, _ = (null === (o = mobileRegex.exec(C)) || void 0 === o ? void 0 : o[1]) || "{}", V = JSON.parse(decodeHex(_)), w = null === (u = null === (r = null === (a = null === (d = null === (l = null === (n = null === (i = V.contents) || void 0 === i ? void 0 : i.singleColumnBrowseResultsRenderer) || void 0 === n ? void 0 : n.tabs[1]) || void 0 === l ? void 0 : l.tabRenderer) || void 0 === d ? void 0 : d.content) || void 0 === a ? void 0 : a.sectionListRenderer) || void 0 === r ? void 0 : r.contents[0]) || void 0 === u ? void 0 : u.itemSectionRenderer;
    let A = (null === (v = null === (c = null === (s = w.continuations) || void 0 === s ? void 0 : s[0]) || void 0 === c ? void 0 : c.nextContinuationData) || void 0 === v ? void 0 : v.continuation) || "", D = [];
...
function formatVideo(e, t) { var o, i, n, l, d; return __awaiter(this, void 0, void 0, (function* () { try {
    if (e.compactVideoRenderer || e.gridVideoRenderer || e.playlistVideoRenderer) {
        ...
        let u = 60 * parseInt(r[0]), s = parseInt(r[1]), c = t ? (null === (d = e.publishedTimeText) || void 0 === d ? void 0 : d.runs[0].text) || "" : yield getVideoDate(a);
        return { id: a, original_title: e.original_title.trim(), title: e.title.trim(), artist: e.artist.trim(), duration: u + s, publishedAt: c };
    }

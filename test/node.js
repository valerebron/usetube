...
let launchTest = async function() {
  // test = await usetube.getChannelVideos('UC0EXZm7W7F7px2rcqecyC6w', new Date(Date.now() - 180*24*60*60*1000))
  ...
  test = await usetube.getVideoSubtitles('Z75bV3ZhIlU')
  ...
  //  test = await usetube.getPlaylistVideos('PLhrglt2nmIGgQdb_L8Ri5bOfBr86qZZgq')
